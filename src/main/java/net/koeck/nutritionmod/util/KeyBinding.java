...
public class KeyBinding {
    ...
    public static final KeyMapping GUI_KEY = new KeyMapping(KEY_OPEN_DIETGUI, KeyConflictContext.IN_GAME, InputConstants.Type.KEYSYM, GLFW.GLFW_KEY_O, KEY_CATEGORY_NUTRITION);
}
