...
public class ModMessages {
    ...
    public static void register() {
        ...
        net.messageBuilder(WeightClassDataSyncS2CPacket.class, id(), NetworkDirection.PLAY_TO_CLIENT)
                .decoder(WeightClassDataSyncS2CPacket::new)
                .encoder(WeightClassDataSyncS2CPacket::toBytes)
                .consumerMainThread(WeightClassDataSyncS2CPacket::handle)
                .add();
    }
